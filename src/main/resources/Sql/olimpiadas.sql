...
VALUES (1, 'Futbol'), (2, 'Baloncesto'), (3, 'Boxeo');
----------------------
-- Tabla `Deportista`
----------------------
...
VALUES (1, 'Alberto Gines', 'M', 80, 180), (2, 'Tadej Pogacar', 'M', 60, 170);
---------------------
-- Tabla `Equipo`
---------------------
CREATE TABLE `Equipo` (
...
VALUES (1, 'España', 'ESP'), (2, 'Francia', 'FRA');
----------------------
-- Tabla `Olimpiada`
-----------------------
...
VALUES ( 1, '2020 Summer', 2020, 'Summer','Tokio'),
	( 2, '2012 Summer',2012, 'Summer', 'London'),
    (3,'2016 Summer', 2016, 'Summer', 'Río' );
--------------------
-- Tabla `Evento`
----------------------
CREATE TABLE `Evento` (
